...
import RichTextViewer from '../ui/RichTextViewer'; // For displaying existing description
...
const StageCriterionForm: React.FC<{
    ...
    const handleChange = (field: keyof Omit<MatrixCriterion, 'id'>, value: string | number) => { // Allow Omit<...>
        setCurrentCriterion(prev => ({ ...prev, [field]: value }));
    };
    
    const handleDescriptionChange = (html: string) => {
      setCurrentCriterion(prev => ({...prev, description: html}));
    }
...
const HackathonStagesForm: React.FC = () => {
  ...
  const [newStageDescription, setNewStageDescription] = useState(''); // HTML content
            ...
            {editingStage?.id === stage.id ? (
              <div className="space-y-3">
                ...
                <RichTextEditor 
                  ...
                  onChange={(html) => setEditingStage({...editingStage!, description: html})}
              ...
              <div>
                <div className="flex justify-between items-start mb-3">
                    <div>
                        ...
                        <RichTextViewer htmlContent={stage.description} className="text-sm text-neutral-600 dark:text-neutral-200" />
                    </div>
                        ...
                        {editingCriterion?.stageId === stage.id && editingCriterion?.criterion?.id === crit.id ? (
                            ...
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <RichTextViewer htmlContent={crit.description} className="text-xs text-neutral-500 dark:text-neutral-200" />
                                </div>
        ...
        <div className="mt-8 pt-6 border-t dark:border-neutral-700">
            ...
            <div className="space-y-4 p-4 bg-neutral-100 dark:bg-neutral-750 rounded-lg">
                ...
                <RichTextEditor
                  ...
                  onChange={(html) => setNewStageDescription(html)}
