...
const OpenGraphPreviewCard: React.FC<OpenGraphPreviewCardProps> = ({ ogConfig, hackathonTitle }) => {
  const {
    ogTitle,
    ogDescription, // This is now HTML
    ogImage,
    ogUrl
  } = ogConfig;
  ...
  // Strip HTML for preview, as OG descriptions are typically plain text.
  const plainTextDescription = (ogDescription || "A brief description of your amazing hackathon event will appear here when shared.")
    ...
    <Card title="Social Share Preview (Approximate)">
      ...
      <div className="w-full max-w-sm mx-auto border border-neutral-300 dark:border-neutral-600 rounded-lg overflow-hidden shadow-lg bg-neutral-50 dark:bg-neutral-700">
        ...
        <div className="p-3">
          ...
          <p className="text-xs text-neutral-600 dark:text-neutral-300 line-clamp-2 leading-snug" title={plainTextDescription}>
