...
import { Answer, Submission, TeamMember, Hackathon, Question as QuestionType } from '../../types'; // Added QuestionType
...
const SubmissionForm: React.FC = () => {
  ...
  const [answers, setAnswers] = useState<Record<string, string>>({}); // Will store HTML for RichText
        ...
        {activeHackathonForForm && activeHackathonForForm.data.status === 'approved' && (
            <>
                ...
                <div>
                  ...
                  {activeHackathonForForm.data.submissionQuestions.map((q: QuestionType) => ( // Specify QuestionType
