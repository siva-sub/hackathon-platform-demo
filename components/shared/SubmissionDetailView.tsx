...
import { Submission, Score, HackathonStage, MatrixCriterion, Hackathon, Team } from '../../types'; 
        ...
        <div className="space-y-3 mt-3">
            {scoresData.scores.map(scoreItem => {
                ...
                return (
                    <div key={scoreItem.criterionId} className="p-2 border-b dark:border-neutral-700 last:border-b-0">
                        ...
                        {scoreItem.comment && <p className="text-xs text-neutral-500 dark:text-neutral-300 mt-1 pl-2"><em>Comment:</em> {scoreItem.comment}</p>}
                    </div>
                );
            })}
            {scoresData.generalComment && (
                <div className="mt-3 pt-3 border-t dark:border-neutral-700">
                    ...
                    <p className="text-sm text-neutral-600 dark:text-neutral-200 whitespace-pre-wrap">{scoresData.generalComment}</p>
                </div>
            )}
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {submission.answers.map(answer => {
              const question = hackathon.data.submissionQuestions.find(q => q.id === answer.questionId);
              return (
