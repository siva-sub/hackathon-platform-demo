...
const HackathonSettingsForm: React.FC = () => {
  ...
  const handlePublicPageChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
  ...
  return (
    <Card title={`General Settings for "${currentHackathon.data.title}"`}>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Textarea label="Rules" name="rules" value={formData.rules} onChange={handleChange} rows={5}
        ...
        <Textarea label="Timeline" name="timeline" value={formData.timeline} onChange={handleChange} rows={5}
        ...
        <Input label="Public Page - Hero Title" name="heroTitle" value={publicPageData.heroTitle} onChange={handlePublicPageChange} />
        <Input label="Public Page - Hero Subtitle" name="heroSubtitle" value={publicPageData.heroSubtitle} onChange={handlePublicPageChange} />
        <Textarea label="Public Page - About Section" name="aboutSection" value={publicPageData.aboutSection} onChange={handlePublicPageChange} 
                  placeholder="AI can help you write compelling copy for this section to engage potential participants."/>
        <Input label="Public Page - Image URL" name="imageUrl" value={publicPageData.imageUrl} onChange={handlePublicPageChange} placeholder="e.g., https://picsum.photos/1200/400" />
